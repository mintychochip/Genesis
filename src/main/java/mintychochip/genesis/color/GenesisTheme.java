    ...
    public GenesisTheme(char[] colors) {
        ...
        if(colors != null) {
            for (int i = 0; i < colors.length; i++) {
                ...
                switch(i) {
                    case 0: this.setHeaderColor(colorCode);
                    case 1: this.setSecondaryHeaderColor(colorCode);
                    case 2: this.setBodyColor(colorCode);
                    case 3: this.setAccents(colorCode);
                    case 4: this.setBullets(colorCode);
                }
            }
        }
    }

...
public class GenesisConfigMarker extends ConfigMarker {

    public static String ingredients = "ingredients";

    public static String shaped_recipe = "shaped-recipe";

    public static String smelting_recipes = "smelting-recipes";

    public static String crafting_recipes = "crafting-recipes";
    public static String smelting_material = "smelting-material";

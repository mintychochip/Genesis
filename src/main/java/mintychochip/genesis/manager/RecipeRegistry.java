...
public class RecipeRegistry {
    private final Map<NamespacedKey, ItemStack> recipeItems = new HashMap<>(); //item to be used in config,

    private final Map<NamespacedKey, ItemStack> recipeResults = new HashMap<>();

    private final Map<String, NamespacedKey> resultMappings = new HashMap<>();

    private final Map<String, NamespacedKey> itemMappings = new HashMap<>();
